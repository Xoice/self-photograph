    ...
    <Box ref={containerRef} sx={{ bgcolor: '#050505', minHeight: '100vh', pt: 15, pb: 10 }}>
      <Container maxWidth="lg">
        ...
        <Box className="expedition-header" sx={{ mb: 8 }}>
          ...
          <Typography variant="h2" sx={{ fontSize: { xs: '1.5rem', md: '2rem' }, fontWeight: 300, mb: 6, color: '#E0A458' }}>
          ...
          <Card sx={{ bgcolor: 'rgba(224, 164, 88, 0.05)', border: '2px solid #E0A458' }}>
            <CardContent sx={{ p: 4 }}>
              <Typography variant="h3" sx={{ fontSize: '2rem', fontWeight: 600, mb: 2, color: '#E0A458' }}>
                ¥36,800/人
              </Typography>
          ...
          <Grid container spacing={3}>
            <Grid size={{ xs: 12, md: 6 }}>
              <Card sx={{ bgcolor: '#0a0a0a', border: '1px solid rgba(234, 234, 234, 0.1)', height: '100%' }}>
                <CardContent sx={{ p: 4 }}>
                  <CameraAlt sx={{ fontSize: 40, color: '#E0A458', mb: 2 }} />
            ...
            <Grid size={{ xs: 12, md: 6 }}>
              <Card sx={{ bgcolor: '#0a0a0a', border: '1px solid rgba(234, 234, 234, 0.1)', height: '100%' }}>
                <CardContent sx={{ p: 4 }}>
                  <CheckCircle sx={{ fontSize: 40, color: '#E0A458', mb: 2 }} />
                  <Typography variant="h5" sx={{ fontSize: '1.5rem', mb: 2, color: '#EAEAEA' }}>
                    专业摄影指导
                  </Typography>
                  <Typography variant="body1" sx={{ color: '#999', lineHeight: 1.8 }}>
        ...
        <Box className="expedition-section" sx={{ mb: 10 }}>
          ...
          <Card sx={{ bgcolor: '#0a0a0a', border: '1px solid rgba(234, 234, 234, 0.1)' }}>
            <CardContent sx={{ p: 4 }}>
              <Stack spacing={4}>
                <Box>
                  <Typography variant="h5" sx={{ color: '#E0A458', mb: 2 }}>第1天：抵达内罗毕</Typography>
                  <Typography variant="body1" sx={{ color: '#999', lineHeight: 1.8 }}>
                ...
                <Box>
                  <Typography variant="h5" sx={{ color: '#E0A458', mb: 2 }}>第2-3天：马赛马拉国家保护区</Typography>
                  <Typography variant="body1" sx={{ color: '#999', lineHeight: 1.8 }}>
                ...
                <Divider sx={{ borderColor: 'rgba(234, 234, 234, 0.1)' }} />
                <Box>
                  <Typography variant="h5" sx={{ color: '#E0A458', mb: 2 }}>第4-6天：马拉河区域</Typography>
                  <Typography variant="body1" sx={{ color: '#999', lineHeight: 1.8 }}>
                ...
                <Divider sx={{ borderColor: 'rgba(234, 234, 234, 0.1)' }} />
                <Box>
                  <Typography variant="h5" sx={{ color: '#E0A458', mb: 2 }}>第7-8天：纳库鲁湖国家公园</Typography>
                  <Typography variant="body1" sx={{ color: '#999', lineHeight: 1.8 }}>
                ...
                <Divider sx={{ borderColor: 'rgba(234, 234, 234, 0.1)' }} />
                <Box>
                  <Typography variant="h5" sx={{ color: '#E0A458', mb: 2 }}>第9-10天：安博塞利国家公园</Typography>
                  <Typography variant="body1" sx={{ color: '#999', lineHeight: 1.8 }}>
                ...
                <Divider sx={{ borderColor: 'rgba(234, 234, 234, 0.1)' }} />
                <Box>
                  <Typography variant="h5" sx={{ color: '#E0A458', mb: 2 }}>第11天：返程</Typography>
                  <Typography variant="body1" sx={{ color: '#999', lineHeight: 1.8 }}>
                ...
                <CardContent sx={{ p: 4 }}>
                  ...
                  <Stack spacing={2}>
                    <Stack direction="row" spacing={2} alignItems="flex-start">
                      <CheckCircle sx={{ color: '#E0A458', fontSize: 20, mt: 0.5 }} />
        ...
        <Box className="expedition-section" sx={{ mb: 10 }}>
          ...
          <Card sx={{ bgcolor: '#0a0a0a', border: '1px solid rgba(234, 234, 234, 0.1)' }}>
            <CardContent sx={{ p: 4 }}>
              <Stack spacing={3}>
                <Box>
                  <Typography variant="h5" sx={{ color: '#E0A458', mb: 2 }}>报名条件</Typography>
                  <Typography variant="body1" sx={{ color: '#999', lineHeight: 1.8 }}>
                ...
                <Divider sx={{ borderColor: 'rgba(234, 234, 234, 0.1)' }} />
                <Box>
                  <Typography variant="h5" sx={{ color: '#E0A458', mb: 2 }}>报名方式</Typography>
                  <Typography variant="body1" sx={{ color: '#999', lineHeight: 1.8 }}>
                ...
                <Divider sx={{ borderColor: 'rgba(234, 234, 234, 0.1)' }} />
                <Box>
                  <Typography variant="h5" sx={{ color: '#E0A458', mb: 2 }}>联系方式</Typography>
                  <Stack spacing={2}>
